...
func TestNone(t *testing.T) {
	t.Run("empty map", func(t *testing.T) {
		...
		want := true
		have := maps.None(vals, func(_ int, _ int) bool { return false })
	...
	t.Run("map with values matching predicate", func(t *testing.T) {
		...
		want := false
		have := maps.None(vals, func(_ int, v int) bool { return v%2 == 0 })
	...
	t.Run("map with values not matching predicate", func(t *testing.T) {
		...
		want := true
		have := maps.None(vals, func(_ int, v int) bool { return v%2 == 1 })
