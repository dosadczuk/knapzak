...
func TestFindLastIndex(t *testing.T) {
	...
	t.Run("slice of primitives", func(t *testing.T) {
		...
		haveValue, haveFound := slices.FindLastIndex(vals, func(val int) bool { return val%2 == 0 })
	...
	t.Run("slice of structures", func(t *testing.T) {
		...
		haveValue, haveFound := slices.FindLastIndex(vals, func(val time.Time) bool {
	...
	t.Run("slice of interfaces", func(t *testing.T) {
		...
		haveValue, haveFound := slices.FindLastIndex(vals, func(val fmt.Stringer) bool {
